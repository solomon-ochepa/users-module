<div wire:ignore.self class="modal fade" id="user-edit-modal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" role="dialog" aria-labelledby="user-edit-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg _modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="user-edit-modalLabel">
                    {{ __('Create User') }}
                </h5>
